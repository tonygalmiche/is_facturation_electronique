...
ENTRIES=(
  "account_invoice_en16931|akretion/fr-einvoicing|18.0|account_invoice_en16931"
  "l10n_fr_account_invoice_en16931|akretion/fr-einvoicing|18.0|l10n_fr_account_invoice_en16931"
  "l10n_fr_siret|OCA/l10n-france|18.0|l10n_fr_siret"
  "account_tax_unece|akretion/community-data-files|18-account_tax_unece-vatex|account_tax_unece"
  "uom_unece|OCA/community-data-files|18.0|uom_unece"
  "account_payment_unece|OCA/community-data-files|18.0|account_payment_unece"
  "base_unece|OCA/community-data-files|18.0|base_unece"
  "intrastat_base|OCA/intrastat-extrastat|18.0|intrastat_base"
  "base_view_inheritance_extension|OCA/server-tools|18.0|base_view_inheritance_extension"
  "account_payment_method_base|OCA/account-payment|18.0|account_payment_method_base"
  "l10n_fr_einvoicing|akretion/fr-einvoicing|18.0|l10n_fr_einvoicing"
  "l10n_fr_siret_account|OCA/l10n-france|18.0|l10n_fr_siret_account"
  "l10n_fr_einvoicing_import|akretion/fr-einvoicing|18.0|l10n_fr_einvoicing_import"
  "account_invoice_import|OCA/edi|18.0|account_invoice_import"
  "account_invoice_import_facturx|OCA/edi|18.0|account_invoice_import_facturx"
  "base_facturx|OCA/edi|18.0|base_facturx"
  "base_business_document_import|OCA/edi|18.0|base_business_document_import"
